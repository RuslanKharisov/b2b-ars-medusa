      ...
      <div className={`flex flex-col w-full`}>
        ...
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            required={required}
            className={clx(
              "pt-4 pb-1 block w-full h-12 px-4 mt-0 bg-ui-bg-field rounded-md appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active shadow-borders-base hover:bg-ui-bg-field-hover",
              className
            )}
            {...props}
            ref={inputRef}
